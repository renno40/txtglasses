            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 30),
                  _buildCustomIconOption('assets/gallery-image.png', 'Import from Gallery'),
                  SizedBox(height: 30),
        ...
        Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 20),
              Text(
                'Assists you in all reading challenges, providing easy access to processed text for better understanding and convenience.',
                style: TextStyle(
                  fontSize: 20,
